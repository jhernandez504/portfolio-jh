export default function About() {
  return (
      <section className="px-4 py-12 max-w-5xl mx-auto">
        <h2 className="text-3xl font-semibold mb-6 text-black dark:text-white text-center">About Me</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center items-center">
            <img src="/images/nola.jpg" alt="New Orleans" className="w-full h-full object-cover max-w-[400px] rounded-xl shadow-md" />
          </div>
          ...
          <div className="flex justify-center items-center">
            <img src="/images/gaming.jpg" alt="Gaming journey" className="w-full h-full object-cover max-w-[400px] rounded-xl shadow-md" />
          </div>
          ...
          <div className="flex justify-center items-center">
            <img src="/images/art.jpg" alt="Art & design" className="w-full h-full object-cover max-w-[400px] rounded-xl shadow-md" />
          </div>
          ...
          <div className="flex justify-center items-center">
            <img src="/images/code.jpg" alt="Coding curiosity" className="w-full h-full object-cover max-w-[400px] rounded-xl shadow-md" />
          </div>
          ...
          <div className="flex justify-center items-center">
            <img src="/images/opspark.jpg" alt="Operation Spark" className="w-full h-full object-cover max-w-[400px] rounded-xl shadow-md" />
          </div>
