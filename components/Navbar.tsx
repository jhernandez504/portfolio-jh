...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 shadow-gray-400 shadow-lg bg-transparent py-1 px-3">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="hidden lg:flex justify-center w-full gap-12 text-white">
              ...
              <Link href="https://docs.google.com/document/d/19Zy4uEAaRvMSY3OW7eU6h4_Ib9oJnvuB-Ew25i7NfZY/edit?usp=sharing" className="hover:text-blue-500 dark:hover:text-white transition-colors duration-200 hover:scale-120">
                /resume
              </Link>
              {/* Skills Button */}
              <button
